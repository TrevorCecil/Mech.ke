...
import com.example.wazitoecommerce.navigation.ADMINADDGAS_URL
...
fun ViewGasScreen(navController: NavHostController) {
    Column(modifier = Modifier
        ...
        var emptyProductsListState = remember { mutableStateListOf<Gas>() }
...
@Composable
fun CarwashItem(
    name:String, county:String, town:String, id:String,
        ...
        Card (modifier = Modifier
            ...
            Column (modifier = Modifier
                ...
                Row {
                    ...
                    Text(text = "UPDATE",
                        Modifier
                            .clickable { navController.navigate(ADMINADDGAS_URL) }
                            .padding(bottom = 5.dp, start = 10.dp),
                        fontSize = 18.sp,
                        fontFamily = FontFamily.Serif,
                        textDecoration = TextDecoration.Underline,
