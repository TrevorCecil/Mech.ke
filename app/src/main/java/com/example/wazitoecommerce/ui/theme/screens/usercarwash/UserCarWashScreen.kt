package com.example.wazitoecommerce.ui.theme.screens.usercarwash
...
@Composable
fun UserCarWashScreen(navController: NavHostController){
...
@Composable
fun UserCarWashPreviewScreen(){
    UserCarWashScreen(navController = rememberNavController())
}