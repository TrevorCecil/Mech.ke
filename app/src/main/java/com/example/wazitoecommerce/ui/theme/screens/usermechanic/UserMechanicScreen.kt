package com.example.wazitoecommerce.ui.theme.screens.usermechanic
...
import com.example.wazitoecommerce.models.Mechanic
...
@Composable
fun UserMechanicScreen(navController: NavHostController){
        ...
        Card (modifier = Modifier
            ...
            Column(modifier = Modifier
                ...
                OutlinedButton(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(start = 50.dp, end = 50.dp, bottom = 5.dp, top = 5.dp)
                        .height(60.dp)
                        .width(150.dp),
...
@Composable
fun UserMechanicPreviewScreen(){
    UserMechanicScreen(navController = rememberNavController())
}