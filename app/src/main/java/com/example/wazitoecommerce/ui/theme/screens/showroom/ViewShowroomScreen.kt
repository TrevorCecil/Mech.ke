package com.example.wazitoecommerce.ui.theme.screens.showroom
...
@Composable
fun ViewShowroomScreen(navController: NavHostController) {
...
fun ViewShowroomScreenPreview(){
    WazitoECommerceTheme {
        ViewShowroomScreen(navController = rememberNavController())
    }
}