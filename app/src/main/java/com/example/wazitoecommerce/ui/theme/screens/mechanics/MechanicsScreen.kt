...
import com.example.wazitoecommerce.navigation.VIEW_MECHANIC_URL
import com.example.wazitoecommerce.ui.theme.newBlue
import com.example.wazitoecommerce.ui.theme.newWhite

@Composable
fun MechanicsScreen(navController: NavHostController) {
    ...
    Column (modifier = Modifier
        ...
        Text(text = "MECHANICS", fontSize = 24.sp,
        ...
        Column (verticalArrangement = Arrangement.Center,
            ...
            Card (modifier = Modifier
                .clickable { navController.navigate(VIEW_MECHANIC_URL) }
                .width(210.dp)
                .height(250.dp)){
...
fun  MechanicsScreenPreview() {
    MechanicsScreen(rememberNavController())
}