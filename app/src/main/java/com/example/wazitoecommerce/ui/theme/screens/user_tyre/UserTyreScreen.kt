package com.example.wazitoecommerce.ui.theme.screens.user_tyre
...
@Composable
fun UserTyreScreen(navController: NavHostController){
    ...
    Column(modifier = Modifier
        ...
        Column(
            ...
            Text(text = "TYRE & SERVICE CENTRES",
                fontSize = 24.sp,
                fontWeight = FontWeight.Bold,
                fontFamily = FontFamily.Serif,
                color = newWhite
...
@Composable
fun UserTyrePreviewScreen(){
    UserTyreScreen(navController = rememberNavController())
}