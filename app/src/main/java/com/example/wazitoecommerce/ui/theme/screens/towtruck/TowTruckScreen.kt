...
import com.example.wazitoecommerce.navigation.ADMINVIEWTOW_URL
...
fun TruckScreen(navController: NavHostController) {
    Column (modifier = Modifier
        ...
        Text(text = "TOW TRUCK", fontSize = 24.sp,
        ...
        Column (verticalArrangement = Arrangement.Center,
            ...
            Card (modifier = Modifier
                .clickable { navController.navigate(ADMINVIEWTOW_URL) }
                .width(210.dp)
                .height(240.dp)){
...
@Composable
fun  TruckScreenPreview() {
    TruckScreen(rememberNavController())
}