...
import com.example.wazitoecommerce.navigation.ADMINVIEWGAS_URL
...
fun GasScreen(navController: NavHostController) {
    Column (modifier = Modifier
        ...
        Text(text = "GAS STATION", fontSize = 24.sp,
        ...
        Column (verticalArrangement = Arrangement.Center,
            ...
            Card (modifier = Modifier
                .clickable { navController.navigate(ADMINVIEWGAS_URL) }
                .width(210.dp)
                .height(240.dp)){
