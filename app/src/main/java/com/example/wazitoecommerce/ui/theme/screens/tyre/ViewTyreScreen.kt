package com.example.wazitoecommerce.ui.theme.screens.tyre
...
import com.example.wazitoecommerce.data.TyreViewModel
import com.example.wazitoecommerce.models.Autoshop
import com.example.wazitoecommerce.models.Tyre
...
fun ViewTyreScreen(navController: NavHostController) {
    Column(modifier = Modifier
        ...
        var productRepository = TyreViewModel(navController, context)


        val emptyProductState = remember { mutableStateOf(Tyre("","","","","","")) }
        var emptyProductsListState = remember { mutableStateListOf<Tyre>() }
...
fun ViewItem(name:String, contact:String, county:String, town:String, id:String,
             ...
             productRepository: TyreViewModel, productImage:String) {
        ...
        Card (modifier = Modifier
            ...
            Column (modifier = Modifier
                ...
                Row {
                    ...
                    Text(text = "UPDATE",
                        Modifier
                            .clickable { navController.navigate(ADMINADDTYRE_URL) }
                            .padding(bottom = 5.dp, start = 10.dp),
                        fontSize = 18.sp,
                        fontFamily = FontFamily.Serif,
                        textDecoration = TextDecoration.Underline,
...
fun ViewTyreScreenPreview(){
    WazitoECommerceTheme {
        ViewTyreScreen(navController = rememberNavController())
    }
}