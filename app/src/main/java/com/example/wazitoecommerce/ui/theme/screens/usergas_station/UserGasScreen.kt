package com.example.wazitoecommerce.ui.theme.screens.usergas_station
...
@Composable
fun UserViewItem(name:String, county:String, town:String, id:String,
...
@Composable
fun UserGasPreviewScreen(){
    UserGasScreen(navController = rememberNavController())
}