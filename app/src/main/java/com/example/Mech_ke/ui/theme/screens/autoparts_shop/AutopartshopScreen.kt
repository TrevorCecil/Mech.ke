...
import com.example.Mech_ke.navigation.ADMIN_ADDAUTOPART_URL
import com.example.Mech_ke.navigation.ADMIN_VIEWAUTOPART_URL
import com.example.Mech_ke.ui.theme.newBlue
import com.example.Mech_ke.ui.theme.newWhite

@Composable
fun AutopartScreen(navController: NavHostController) {
    Column (modifier = Modifier
        ...
        Text(text = "AUTO PARTS", fontSize = 24.sp,
        ...
        Column (verticalArrangement = Arrangement.Center,
            ...
            Card (modifier = Modifier
                .clickable { navController.navigate(ADMIN_VIEWAUTOPART_URL) }
                .width(210.dp)
                .height(250.dp)){
...
@Composable
fun  AutopartScreenPreview() {
    AutopartScreen(rememberNavController())
}