package com.example.Mech_ke.ui.theme.screens.carwash
...
import com.example.Mech_ke.navigation.ADMINADDCARWSH_URL
...
@Composable
fun ViewCarWashScreen(navController: NavHostController) {
    Column(modifier = Modifier
        ...
        var productRepository = CarWashViewModel(navController, context)


        val emptyProductState = remember { mutableStateOf(CarWash("","","","","","")) }
        var emptyProductsListState = remember { mutableStateListOf<CarWash>() }
...
fun CarwashItem(
    ...
    productRepository: CarWashViewModel, productImage:String) {
...
fun ViewCarWashScreenPreview(){
    WazitoECommerceTheme {
        ViewCarWashScreen(navController = rememberNavController())
    }
}