package com.example.Mech_ke.ui.theme.screens.user_tow
...
@Composable
fun UserTowScreen(navController: NavHostController){
...
@Composable
fun UserTowPreviewScreen(){
    UserTowScreen(navController = rememberNavController())
}